...
namespace AdmissionsCommittee.Reports.ExcelGenerators
{
    public class ExcelGenerator
    {
        public byte[] Generate(EnrolleeReport report)
        {
            ...
            sheet.Cells["F2"].Value = "Возраст";
            sheet.Cells["G2"].Value = "СНИЛС";
            sheet.Cells["H2"].Value = "Год поступления";
            sheet.Cells["I2"].Value = "Бюджет";
            sheet.Cells["J2"].Value = "Зачислен";
            sheet.Cells["K2"].Value = "Гражданство";
            sheet.Cells["L2"].Value = "Образование";
            sheet.Cells["M2"].Value = "Инвалидность";
            sheet.Cells["N2"].Value = "Средний бал аттестата";
            sheet.Cells["O2"].Value = "Оригинал аттестата";
            sheet.Cells["P2"].Value = "Опекаемый";
            sheet.Cells["Q2"].Value = "Субъект проживания";
            sheet.Cells["R2"].Value = "Район";
